...
class MasterBkFilter extends QueryFilters
{
    protected $request;
    ...
    public function bidang($term) {
        return $this->builder->where('bidang', "LIKE","%$term%");
    }

    public function keluhan($term) {
        return $this->builder->where('keluhan', "LIKE","%$term%");
    }
