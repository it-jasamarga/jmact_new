                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <fieldset class="form-group">
                            <input type="text" data-post="no_tiket" id="dataFilter" class="form-control filter-control"
                                placeholder="No Tiket" autocomplete="off">
                        </fieldset>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-4">
                        <label for="users-list-role">Nama Pelanggan</label>
                        <fieldset class="form-group">
                            <input type="text" data-post="nama_pelanggan" id="dataFilter"
                                class="form-control filter-control" placeholder="Nama Pelanggan" autocomplete="off">
                        </fieldset>
                    </div>
                    {{-- <div class="col-12 col-sm-6 col-lg-4">
