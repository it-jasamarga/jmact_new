  ...
  <form>
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          ...
          <fieldset class="form-group">
            <input type="text" data-post="kontak_cust" id="dataFilter" class="form-control filter-control" placeholder="Nama Pelanggan">
          </fieldset>
        </div>
        <div class="col-12 col-sm-6 col-lg-4">
          <label for="users-list-role">Nama Agent</label>
          <fieldset class="form-group">
            <input type="text" data-post="user_id" id="dataFilter" class="form-control filter-control" placeholder="Nama Agent">
          </fieldset>
        </div>
        <div class="col-12 col-sm-6 col-lg-4">
