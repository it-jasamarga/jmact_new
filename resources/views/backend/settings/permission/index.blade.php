  ...
  <form>
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <label for="users-list-role">Permission</label>
        <fieldset class="form-group">
          <input type="text" data-post="name" id="dataFilter" class="form-control filter-control" placeholder="Permission" autocomplete="off">
        </fieldset>
      </div>
