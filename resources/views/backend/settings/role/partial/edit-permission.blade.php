    ...
    <thead>
        <tr>
            <th class="text-center" width="250">
                <div class="btn btn-light-primary font-weight-bold btn-addon btn-sm"><i class="flaticon2-menu-4"></i>Fitur
                </div>
            </th>
            <th class="text-center">
                <div class="btn btn-light-primary font-weight-bold btn-addon btn-sm"><i class="flaticon2-menu-4"></i>Aksi
                    Fitur</div>
            </th>
            <th class="text-center">
                <div class="btn btn-light-primary font-weight-bold btn-addon btn-sm"><i
                        class="flaticon2-menu-4"></i>Checklist</div>
            </th>
        </tr>
    </thead>
        ...
        @else
            <thead>
                ...
                @if (isset($item->submenu) && count($item->submenu) > 0)
                    <th class="text-center">
                        <div class="btn btn-light-primary font-weight-bold btn-addon btn-sm"><i
                                class="flaticon2-menu-4"></i>Aksi Fitur</div>
                    </th>
                    <th class="text-center">
                        <div class="btn btn-light-primary font-weight-bold btn-addon btn-sm"><i
                                class="flaticon2-menu-4"></i>Checklist</div>
                ...
                @else
                        ...
                        <div class="checkbox-inline">
                            @if ($perms->count() > 0)
                                @foreach ($perms as $k => $value)
                                    <label
                                        class="checkbox checkbox-square checkbox-outline checkbox-outline-2x checkbox-success">
                                        <input name="check[]" class="index check" type="checkbox"
                                            value="{{ $value->name }}"
                                            @if ($record->hasPermissionTo($value->name)) checked @endif>
                    ...
                    <th class="text-center">
                        <button class="btn btn-pesat-colour btn-addon btn-sm horizontal all"><i
                                class="flaticon2-checkmark"></i>Check </button>
                    </th>
                @endif
            </thead>
            ...
            @if (isset($item->submenu) && count($item->submenu) > 0)
                <thead>
                    @foreach ($item->submenu as $bigChild)
                        <tr>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i
                                    class="{{ isset($bigChild->icon) ? $bigChild->icon : '' }} icon"></i>
                                {!! $bigChild->name !!} </td>
                            @php
                            ...
                            <th class="text-center">
                                <button class="btn btn-pesat-add btn-addon btn-sm horizontal all"><i
                                        class="flaticon2-checkmark"></i>Check </button>
                            </th>
                        </tr>
                    @endforeach
