                ...
                @if($record->count() > 0)
                    @foreach($record as $k => $value)
                        @php
                            ...
                            } else if (strpos($value->title, 'Klaim ') !== false) {
                        ...
                        <div class="d-flex align-items-start list-item card-spacer-x py-3" data-inbox="message">
                            ...
                            <div class="flex-grow-1 mt-2 mr-2" data-toggle="view">
                                <div>
                                    <span class="{{$value->status == 'Unread' ? 'font-weight-bolder' : 'text-muted' }} font-size-lg mr-2">{{$title}}  -</span>
                            ...
                            <!--end::Info-->
                            <!--begin::Datetime-->
                            <div class="mt-2 mr-3 {{$value->status == 'Unread' ? 'font-weight-bolder' : 'text-muted' }} w-80px text-right" data-toggle="view">8:30 PM</div>
                            <!--end::Datetime-->
                        </div>
                    @endforeach
                @endif
