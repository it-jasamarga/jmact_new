...
class AppVarSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            [ 'name' => "Chart Klaim Type Rambu portal di gerbang tol", 'value' => "#DACC96" ],
            [ 'name' => "Chart Klaim Type Sarana dan prasarana di gerbang tol", 'value' => "#F3C5C5" ],
            [ 'name' => "Chart Klaim Type Kejatuhan ALB", 'value' => "#C1A3A3" ],
            [ 'name' => "Chart Klaim Type Kelebihan pemotongan saldo", 'value' => "#886F6F" ],
            [ 'name' => "Chart Klaim Type Kesalahan deteksi golongan", 'value' => "#694E4E" ],
            [ 'name' => "Chart Klaim Type Pengaturan lalu lintas", 'value' => "#FFE162" ],
            [ 'name' => "Chart Klaim Type Pentalan material", 'value' => "#FF6464" ],
            [ 'name' => "Chart Klaim Type Rintangan di jalan tol (batu, balok, besi)", 'value' => "#91C483" ],
            [ 'name' => "Chart Klaim Type Pelemparan Batu", 'value' => "#EEEEEE" ],
            [ 'name' => "Chart Klaim Type Gangguan orang gila/hewan", 'value' => "#C0D8C0" ],
            [ 'name' => "Chart Klaim Type Naik turun Penumpang", 'value' => "#F5EEDC" ],
            [ 'name' => "Chart Klaim Type Lainnya yang termasuk lingkup pengoperasian jalan tol", 'value' => "#DD4A48" ],
            [ 'name' => "Chart Klaim Type Lubang", 'value' => "#ECB390" ],
            [ 'name' => "Chart Klaim Type Gundukan Aspal", 'value' => "#FF6363" ],
            [ 'name' => "Chart Klaim Type Genangan Air", 'value' => "#FFAB76" ],
            [ 'name' => "Chart Klaim Type Pohon tumbang", 'value' => "#FFFDA2" ],
            [ 'name' => "Chart Klaim Type Kerusakan rambu di lajur", 'value' => "#BAFFB4" ],
            [ 'name' => "Chart Klaim Type Kerusakan PJU", 'value' => "#781C68" ],
            [ 'name' => "Chart Klaim Type Konstruksi jembatan", 'value' => "#9A0680" ],
            [ 'name' => "Chart Klaim Type Kegiatan pemeliharaan", 'value' => "#FFD39A" ],
            [ 'name' => "Chart Klaim Type Pagar/Rambu proyek", 'value' => "#FFF5E1" ],
            [ 'name' => "Chart Klaim Type Sarkapja (guardrail, rambu, marka, dll.)", 'value' => "#6867AC" ],
            [ 'name' => "Chart Klaim Type Lainnya yang termasuk lingkup pemeliharaan jalan tol", 'value' => "#A267AC" ],
            [ 'name' => "Chart Klaim Type Konstruksi billboard/iklan", 'value' => "#CE7BB0" ],
            [ 'name' => "Chart Klaim Type keluhan terkait rest area", 'value' => "#FFBCD1" ],
            [ 'name' => "Chart Klaim Type Lubang di rest area", 'value' => "#D9D7F1" ],
            [ 'name' => "Chart Klaim Type Genangan Air di rest area", 'value' => "#FFFDDE" ],
            [ 'name' => "Chart Klaim Type Lainnya yang termasuk lingkup pengelolaan rest area", 'value' => "#FFA1C9" ]
        ];
