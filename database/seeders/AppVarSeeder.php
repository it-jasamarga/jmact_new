...
class AppVarSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            [ 'name' => "Chart Source Call Center 14080", 'value' => "#E6DDC4" ],
            [ 'name' => "Chart Source Travoy", 'value' => "#678983" ],
            [ 'name' => "Chart Source Twitter", 'value' => "#7EB5A6" ],
            [ 'name' => "Chart Source Instagram", 'value' => "#C36839" ],
            [ 'name' => "Chart Source Facebook", 'value' => "#86340A" ],
            [ 'name' => "Chart Source Youtube", 'value' => "#E8D0B3" ],
            [ 'name' => "Chart Source Media Cetak", 'value' => "#DAD992" ],
            [ 'name' => "Chart Source Laporan Petugas", 'value' => "#E6DF9A" ],
            [ 'name' => "Chart Source Whatsapp", 'value' => "#FFFEA9" ],
            [ 'name' => "Chart Source Lain Lain", 'value' => "#" ],
            [ 'name' => "Chart Sector Iklan", 'value' => "#F1C5C5" ],
            [ 'name' => "Chart Sector Konstruksi", 'value' => "#FAF0AF" ],
            [ 'name' => "Chart Sector Lalin", 'value' => "#E5EDB7" ],
            [ 'name' => "Chart Sector Rest Area", 'value' => "#8BCDCD" ],
            [ 'name' => "Chart Sector Transaksi", 'value' => "#ABC2E8" ],
            [ 'name' => "Chart Sector Lain-Lain", 'value' => "#" ]            
        ];
